...
const LOGO_ABSOLUTE_URL = 'https://raw.githubusercontent.com/filipmrbg/Gc-Elteknik-AB/main/public/og-image.png';
...
export function usePageTitle(title: string, description?: string) {
  ...
  useEffect(() => {
    ...
    const defaultDesc = "Gc Elteknik AB erbjuder certifierade elinstallationer, belysningslösningar, laddboxar och byte av elcentraler för privatpersoner och företag i Stockholm med omnejd.";
